    ...
    <>
      ...
      <div className="mx-auto max-w-lg">
        ...
        <Card className="mb-3">
          ...
          <ol className="list-decimal space-y-1.5 pl-5 text-sm text-stone-600 dark:text-stone-300">
            <li>Show your bookmarks bar (<span className="rounded bg-stone-100 dark:bg-stone-800 px-1 py-0.5 text-xs">Ctrl+Shift+B</span>)</li>
          ...
          <div className="mt-3 flex items-center gap-2">
            <a
              ...
              className="inline-flex cursor-grab items-center gap-1.5 rounded-md bg-stone-900 dark:bg-stone-100 px-3 py-1.5 text-sm text-white dark:text-stone-900 active:cursor-grabbing"
            >
              <BookmarkPlus className="h-4 w-4" /> Capture role
            </a>
            <span className="text-xs text-stone-400 dark:text-stone-500">← drag, don&apos;t click</span>
          </div>
          <div className="mt-3 border-t border-stone-200 dark:border-stone-800 pt-3 text-[13px] text-stone-500 dark:text-stone-400">
            Can&apos;t drag? <button onClick={copy} className="inline-flex items-center gap-1 text-stone-700 dark:text-stone-300 underline hover:text-stone-900 dark:hover:text-stone-100">
